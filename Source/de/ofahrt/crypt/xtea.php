<?php
/*
 * Modified by Ulf Ochsenfahrt <ulf@ofahrt.de>
 * I removed the PEAR dependency.
 * I changed the byte order to LITTLE ENDIAN.
 * I removed the length prefix that is put in front of the data.
 */
//
// +----------------------------------------------------------------------+
// | PHP version 4.0                                                      |
...
//        $data_long[0]   = $n;
        $n_data_long    = $this->_str2long(0, $data, $data_long);
